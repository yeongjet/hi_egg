...
class FileLoader {
  ...
  loadModule(declareTo) {
    ...
    console.log(composeArrayToObject(declareTo.split('.'), target));
    return composeArrayToObject(declareTo.split('.'), target);
  }
